/*
Maven Analytics - Advanced MySQL Midcourse Project
Analysis and SQL by William Frizzell-Carlton
14 NOV 2022
mavenfuzzyfactory database provided by Maven Analytics (mavenanalytics.io)
*/

USE mavenfuzzyfactory;

/*
     Maven Fuzzy Factory CEO, Cindy Sharp, approached the data analytcis team to pull information for a presentation 
at board meeting next week, detailing growth in the company over the first 8 months. Please answer the following 8
questions. The hypothetical date of the request is '2012-11-27'
*/
